...
<!---main starts--->
   	  <div class="mainpage">
      			<!--Mainheading starts-->
                	<div class="main_heading">Create Policy Page</div>
                <!--Mainheading closed-->
                <div class="clear"></div>
                    	...
                    	<!---CMS form starts--->
							...
							<?php endif; ?>
                      		<div class="blog_uploading">
                                <?php echo form_open("policy/create_policy","enctype='multipart/form-data'") ?>
                                	<!---Page Name starts--->
                                    <div class="blog_uploading_label"><span class="alert-error">*</span>Sub Menu:</div>
                                    <div class="blog_uploading_field">
                                    <select class="textbox3" id="sub_menu" name="sub_menu">
                                    <?php foreach($subMenu as $subMenus) {?>
                                    <option value="<?php echo $subMenus['id']; ?>"><?php echo $subMenus['sub_menu_name']; ?></option>
                                    <?php } ?>
                                    </select>
                                    </div>
                                    <div class="clear"></div>
                                    ...
                                    <div class="blog_uploading_field"><input name="page_name" type="text" class="textbox3" value="<?php echo set_value('page_name');?>" required/></div>
                                    ...
                                    <div class="blog_uploading_field"><input name="meta_title" type="text" class="textbox3" value="<?php echo set_value('meta_title');?>" required/></div>
                                    ...
                                    <div class="blog_uploading_field"><input name="meta_keyword" type="text" class="textbox3" value="<?php echo set_value('meta_keyword');?>" required/></div>
                                    ...
                                    <div class="blog_uploading_field"><input name="meta_description" type="text" class="textbox3" value="<?php echo set_value('meta_description');?>" required/></div>
                                    ...
                                    <div class="blog_uploading_field">
									<?php echo form_textarea(array("name" => "page_content", "value" => set_value("page_content"), "class" => "ckeditor")) ?>
									</div>
                                    ...
                                    <!--Submit starts--->
                                    <div class="blog_uploading_field">
                                    	<input name="submit" type="submit" value="Submit" class="cssButton" title="Click to Add"/>
